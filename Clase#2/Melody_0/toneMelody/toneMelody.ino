...
#define speakerOut 9
         ...
         #define  R     0      // "Una nota especial", representa un silencio

// Melodía 1: Marcha Imperial de la Guerra de las Galaxias
...
// Melodía 2: Tema de la Guerra de las Galaxias (Una Nueva Esperanza)
